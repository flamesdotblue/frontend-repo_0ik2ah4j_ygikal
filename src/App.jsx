...
export default function App() {
  ...
  const introBg = 'https://source.unsplash.com/1600x900/?barcelona,skyline,cityscape';
  const foodBg = 'https://source.unsplash.com/1600x900/?barcelona,food,tapas';
  const cultureBg = 'https://source.unsplash.com/1600x900/?barcelona,culture,catalan';
  const landmarksBg = 'https://source.unsplash.com/1600x900/?barcelona,gaudi,architecture';
  const festivalsBg = 'https://source.unsplash.com/1600x900/?barcelona,festival,fireworks';
  const sportsBg = 'https://source.unsplash.com/1600x900/?barcelona,sports,stadium';
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      ...
      <section className="relative h-[70vh] md:h-[80vh] flex items-center">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pt-20 md:pt-24 w-full">
